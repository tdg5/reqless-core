...
class TestRelease(TestReqless):
  ...
  def test_next_job_is_moved_into_work_qeueue(self):
    ...
    self.assertEqual(self.lua('throttle.pending', 4, 'tid'), [b'jid2'])
    self.assertEqual(self.lua('queue.jobsByState', 5, 'throttled', 'queue'), [b'jid2'])
    self.assertEqual(self.lua('queue.jobsByState', 6, 'running', 'queue'), [b'jid1'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 16, 'running', 'queue'), [b'jid2'])
  ...
  def test_on_cancel_next_job_is_moved_into_work_queue(self):
    ...
    self.assertEqual(self.lua('queue.jobsByState', 13, 'throttled', 'queue'), [])
    self.assertEqual(self.lua('queue.jobsByState', 14, 'running', 'queue'), [b'jid2'])
  ...
  def test_on_retry_with_pending_lock_is_not_reacquired(self):
    ...
    self.assertEqual(self.lua('queue.jobsByState', 13, 'throttled', 'queue'), [b'jid1'])
...
class TestConcurrencyLevelChange(TestReqless):
  ...
  def test_increasing_concurrency_level_activates_pending_jobs(self):
    ...
    self.assertEqual(self.lua('throttle.locks', 5, 'tid'), [b'jid1'])
    self.assertEqual(self.lua('queue.jobsByState', 6, 'throttled', 'queue'), [b'jid2', b'jid3'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 13, 'running', 'queue'), [b'jid2', b'jid3'])
  ...
  def test_reducing_concurrency_level_without_pending(self):
    ...
    self.assertEqual(self.lua('queue.jobsByState', 13, 'throttled', 'queue'), [b'jid4', b'jid5'])
    self.assertEqual(self.lua('queue.jobsByState', 14, 'running', 'queue'), [b'jid1',
        b'jid2', b'jid3'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 18, 'throttled', 'queue'), [b'jid4', b'jid5'])
    self.assertEqual(self.lua('queue.jobsByState', 19, 'running', 'queue'), [b'jid2', b'jid3'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 23, 'throttled', 'queue'), [b'jid4', b'jid5'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 27, 'throttled', 'queue'), [b'jid5'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 32, 'throttled', 'queue'), [b'jid5'])
    self.assertEqual(self.lua('queue.jobsByState', 33, 'running', 'queue'), [b'jid4'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 43, 'running', 'queue'), [b'jid5'])
  ...
  def test_reducing_concurrency_level_with_pending(self):
    ...
    self.assertEqual(self.lua('throttle.locks', 7, 'tid'), [b'jid1', b'jid2', b'jid3'])
    self.assertEqual(self.lua('queue.jobsByState', 8, 'throttled', 'queue'), [b'jid4', b'jid5'])
    self.lua('throttle.set', 9, 'tid', 1)
    self.assertEqual(self.lua('throttle.locks', 10, 'tid'), [b'jid1', b'jid2', b'jid3'])
    self.assertEqual(self.lua('queue.jobsByState', 11, 'throttled', 'queue'), [b'jid4', b'jid5'])
    self.lua('job.complete', 12, 'jid1', 'worker', 'queue', {})
    self.assertEqual(self.lua('throttle.locks', 13, 'tid'), [b'jid2', b'jid3'])
    self.assertEqual(self.lua('queue.jobsByState', 14, 'throttled', 'queue'), [b'jid4', b'jid5'])
    self.lua('job.complete', 15, 'jid2', 'worker', 'queue', {})
    self.assertEqual(self.lua('throttle.locks', 16, 'tid'), [b'jid3'])
    self.assertEqual(self.lua('queue.jobsByState', 17, 'throttled', 'queue'), [b'jid4', b'jid5'])
    ...
    self.assertEqual(self.lua('queue.jobsByState', 21, 'throttled', 'queue'), [b'jid5'])
